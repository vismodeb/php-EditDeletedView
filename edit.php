<?php
  ...
  if(isset($_POST['reg_submit'])){
    ...
    if(empty($name)){
      ...
      $statement = $connection->prepare("UPDATE st_data SET name=?,roll=?,registration=?,phone=?,status=? WHERE id=?");
      $result = $statement->execute(array($name,$roll,$registration,$phone,$status,$id));

      if($result == true){
        $success = 'Data update Successfully!';

        header('location:index.php?success=Data Update Successfully!');
      }
      else{
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
          <div class="navbar-nav">
            ...
            <a class="nav-link active" href="#">Update Data</a>
          </div>
        </div>
      </div>
    </nav>
          ...
          <div class="col-md-6 offset-md-3">
            <div class="card">
              <div class="card-body">
                ...
                <?php
                  $stmt=$connection->prepare('SELECT * from st_data WHERE id=?');
                ...
                <form action="" method="POST">
                  ...
                  <div class="mb-3">
                    ...
                    <input type="number" class="form-control" id="registration" name="registration" value="<?php echo $result['registration']; ?>">
                  </div>
                  <div class="mb-3">
